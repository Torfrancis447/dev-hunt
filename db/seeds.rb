...
puts "seeding skills"
Skill.create(name: "javascript", job_id: js1.id)
Skill.create(name: "MySQL", job_id: js2.id)
Skill.create(name: "java", job_id: js1.id)
Skill.create(name: "aws", job_id: js3.id)
Skill.create(name: "python", job_id: js1.id)
Skill.create(name: "react", job_id: js1.id)
Skill.create(name: "react", job_id: js3.id)
Skill.create(name: "javascript", job_id: jh1.id)
Skill.create(name: "MySQL", job_id: jh2.id)
Skill.create(name: "java", job_id: jh1.id)
Skill.create(name: "aws", job_id: jh3.id)
Skill.create(name: "python", job_id: jh1.id)
Skill.create(name: "react", job_id: jh1.id)
Skill.create(name: "react", job_id: jh3.id)
